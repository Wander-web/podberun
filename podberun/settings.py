"""
Django settings for podberun project.
...
SECRET_KEY = 'django-insecure-y=r*8&a3n-ds^wrxgge6tld7nvdl@v-rweyrrmkd$5ssq&q8vz'
...
WSGI_APPLICATION = 'podberun.wsgi.application'
